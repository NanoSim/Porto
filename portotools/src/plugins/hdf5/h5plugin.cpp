...
using porto::hdf5::QH5;
using porto::hdf5::QH5Dataset;
using porto::hdf5::QH5Datatype;
using porto::hdf5::QH5Group;
using porto::hdf5::QH5Property;
using porto::hdf5::QH5Attribute;
using porto::hdf5::QH5Dataspace;
using porto::hdf5::QH5File;


Q_DECLARE_METATYPE (porto::hdf5::QH5*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Dataset*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Datatype*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Group*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Property*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Attribute*)
Q_DECLARE_METATYPE (porto::hdf5::QH5Dataspace*)
Q_DECLARE_METATYPE (porto::hdf5::QH5File*)
