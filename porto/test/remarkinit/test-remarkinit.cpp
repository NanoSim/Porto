...
TEST(PortoRemarkInitTest, InitFromStorage)
{
  auto storage = new soft::Storage("external", "remark-init:///tmp/generated.in");
  ASSERT_TRUE(nullptr != storage);
  delete storage;
}

TEST(PortoRemarkInitTest, WriteFromEntity)
{
  auto storage = new soft::Storage("external", "remark-init:///tmp/generated.in");
...
TEST(PortoRemarkInitTest, ReadFromEntity)
{
  auto storage = new soft::Storage("external", "remark-init:///tmp/generated.in");
  auto remarcConfig = new soft::Remarcsetup();
